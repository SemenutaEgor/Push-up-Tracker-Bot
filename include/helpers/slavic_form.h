...
constexpr auto GetSlavicDays = SlavicGenerate({"дней", "день", "дня",
                                               "дней", "дня", "дней",
                                               "дней", "дню", "дням",
                                               "дней", "день", "дня",
                                               "дней", "днём", "днями",
...
constexpr auto GetSlavicHours = SlavicGenerate({"часов", "час", "часа",
                                                "часов", "часа", "часов",
                                                "часов", "часу", "часам",
                                                "часов", "час", "часа",
                                                "часов", "часом", "часами",
...
constexpr auto GetSlavicMinutes = SlavicGenerate({"минут", "минута", "минуты",
                                                  "минут", "минуты", "минут",
...
constexpr auto GetSlavicSeconds = SlavicGenerate({"секунд", "секунда", "секунды",
...
constexpr auto GetSlavicPages = SlavicGenerate({"страниц", "страница", "страницы",
...
constexpr auto GetSlavicRounds = SlavicGenerate({"раундов", "раунд", "раунда",
...
constexpr auto GetSlavicBooks = SlavicGenerate({"книг", "книга", "книги",
                                                "книг", "книги", "книг",
                                                "книг", "книге", "книгам",
                                                "книг", "книгу", "книги",
                                                "книг", "книгой", "книгами",
...
constexpr auto GetSlavicSymbols = SlavicGenerate({"символов", "символ", "символа",
